...
# Due to x position determined at upper left, we combine width of paddle and paddle1_x to achieve same distance
...
while do_main:
    ...
    # collision of paddle with edges of screen
    if paddle1_y < 0:
        paddle1_y = 0
